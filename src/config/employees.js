...
export const EMPLOYEES = Object.freeze([
  Object.freeze({
    ...
    biography: Object.freeze([
      'Ro Henry is the provider behind Ro\u2019s Family Medicine. ' +
      'She listens before reaching for an answer, explains what she sees in plain language, ' +
      'and leaves room for the details that can change a visit.',
      'The bright red scrubs and the chicken on her shoulder probably tell you something useful about Ro, too. ' +
      'She brings warmth and a sense of humor into the room. A medical visit can still feel human.',
    ]),
  }),
])
