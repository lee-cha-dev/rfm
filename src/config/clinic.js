...
const DEFAULTS = {
    ...
    contact: {
        phone: {display: '(501) 813-0879', href: '+15018130879'},
        address: {
    ...
    homeSections: {
        about: {
            ...
            body: 'Family medicine works best when care builds over time.'
                + ' Seeing the same clinic for a wellness visit or a stubborn cough'
                + ' helps put today’s concern in context.'
                + ' So do the questions that come up between visits.',
        ...
        services: {
            ...
            lede: 'Come in for routine care or an illness that caught you off guard.'
                + ' We also help manage conditions that need attention over time,'
                + ' with a plan built for the life you are actually living.',
        },
        insurance: {
        ...
        hours: {
            ...
            body: 'Check the schedule before you plan the drive to our Fayetteville clinic.'
                + ' Around holidays or bad-weather days, please call before heading over.',
        ...
        faq: {
            ...
            lede: 'Appointments come with practical questions.'
                + ' Check these answers before you grab your keys,'
                + ' then visit the full FAQ page when you need more detail.',
    ...
    pageContent: {
        about: {
            eyebrow: 'Our mission',
            heading: 'Your Health. Your Story. Our Focus.',
            lede: 'We give each patient time to be heard and explain their care in simple terms.',
            mission: {
                heading: 'Mission Statement',
                body: 'Ro’s Family Medicine provides fast, accessible, and affordable family medicine'
                    + ' care through a transparent, patient-first model.'
                    + ' We eliminate the barriers - financial, geographic, and administrative —'
                    + ' that prevent Arkansans from getting the care they need,'
                    + ' regardless of insurance status.',
            },
            vision: {
                heading: 'Vision Statement',
                body: 'To transform healthcare access across Arkansas by making quality medical care'
                    + ' simple, transparent, and available to everyone,'
                    + ' regardless of their insurance status, location, or economic circumstances.',
            },
            coreValues: {
                heading: 'Core Values',
                items: [
                    {
                        id: 'transparency',
                        name: 'Transparency',
                        description: 'Patients know what care costs before they receive it.'
                            + ' Upfront pricing eliminates surprise bills and hidden fees for self-pay'
                            + ' and membership patients, while insured patients receive clear'
                            + ' communication about their coverage and out-of-pocket responsibilities.',
                    },
                    {
                        id: 'accessibility',
                        name: 'Accessibility',
                        description: 'Healthcare should be available when and where patients need it.'
                            + ' By accepting both insured and uninsured patients, and by building a'
                            + ' membership model that makes primary care affordable for those without'
                            + ' coverage, we ensure that no Arkansan is turned away at the door.',
                    },
                    {
                        id: 'quality',
                        name: 'Quality',
                        description: 'Affordable care is never compromised care.'
                            + ' All clinical services are delivered by licensed, certified Nurse'
                            + ' Practitioners providing evidence-based family medicine.',
                    },
                    {
                        id: 'patient-first',
                        name: 'Patient-First',
                        description: 'Every operational, staffing, and financial decision is evaluated'
                            + ' through the lens of the patient experience and outcome.',
                    },
                    {
                        id: 'simplicity',
                        name: 'Simplicity',
                        description: 'We design our processes to reduce friction: straightforward'
                            + ' scheduling, clear payment options, and efficient workflows'
                            + ' that respect patients’ time.',
                    },
                ],
            },
        },
        ...
        privacy: {
            ...
            lede: 'Tebra runs the patient portal.'
                + ' Its policies cover information handled inside that platform;'
                + ' the clinic’s own Notice of Privacy Practices covers how the practice may use'
                + ' and share protected health information.',
            websiteNotice: 'This website does not provide a public contact form.'
                + ' Call the clinic for appointments, and use the secure Patient Portal'
                + ' for medical questions or private details.',
            portalNotice: 'Use the Tebra Patient Portal for patient communication.'
                + ' Tebra says information provided through its platform may be protected health'
                + ' information and is handled under federal and state law plus its agreement'
                + ' with the healthcare provider.',
            clinicNotice: 'Ro’s Family Medicine has not supplied its approved Notice of Privacy'
                + ' Practices for this preview.'
                + ' HHS requires a HIPAA-covered provider with a website to post its current notice'
                + ' there, so this page cannot stand in for the clinic’s signed policy.',
            resources: [
                {
                    id: 'tebra-platform-privacy',
                    label: 'Tebra Platform Privacy Policy',
                    href: 'https://www.tebra.com/platform-privacy-policy',
                    description: 'Covers the EHR, Patient Portal, telehealth, billing,'
                        + ' and related Tebra platform services.',
                },
                {
                    id: 'tebra-portal-terms',
                    label: 'Tebra Patient Portal Terms of Service',
                    href: 'https://www.tebra.com/patient-portal-terms-service',
                    description: 'Explains portal use, account responsibilities, patient information,'
                        + ' and limits of the service.',
                },
                {
                    id: 'tebra-security',
                    label: 'Tebra Security Notice',
                    href: 'https://www.tebra.com/security-notice',
                    description: 'Describes sign-in controls, encryption, role-based access,'
                        + ' and other platform safeguards.',
                },
                {
                    id: 'tebra-baa',
                    label: 'Tebra Business Associate Agreement',
                    href: 'https://www.tebra.com/business-associate-agreement',
                    description: 'Sets the HIPAA terms between Tebra and a healthcare customer'
                        + ' when Tebra handles protected health information.',
                },
                {
                    ...
                    description: 'Explains what a provider’s clinic-specific notice must tell patients'
                        + ' and where that notice must be available.',
                },
            ],
        },
    },
    ...
    faqs: [
        {
            ...
            answer: 'Yes. New-patient availability can change, so please call the clinic before'
                + ' choosing us as your primary care provider.'
                + ' The staff can advise you what appointments are open and what information is needed.',
        },
        {
            id: 'first-visit',
            question: 'What should I bring to my first visit?',
            answer: 'Bring a photo ID, your current insurance card, and a complete list of the'
                + ' prescription medicines, over-the-counter medicines, vitamins, and supplements'
                + ' you take. Add the dose when you know it, along with any records or forms the'
                + ' clinic asked you to complete.',
        },
        {
            id: 'patient-portal',
        ...
        },
        {
            ...
            answer: 'The insurance section on the home page lists the carriers currently shown'
                + ' for the clinic. Networks can vary by plan, so call the number on your insurance'
                + ' card and the clinic before your appointment to confirm coverage'
                + ' and ask about your expected cost.',
        },
        {
            id: 'prescription-refills',
            question: 'How do I request a prescription refill?',
            answer: 'Contact your pharmacy for a refill before you run out or send a refill request'
                + ' via the patient portal. Some medicines may require an appointment or monitoring'
                + ' before another refill; the clinic will let you know if anything else is needed.'
                + ' The clinic will provide a one time 2-4 week refill if a follow-up appointment'
                + ' is required.',
        },
        {
            id: 'test-results',
            question: 'How will I receive my test results?',
            answer: 'Ask how and when to expect your results when a test is ordered.'
                + ' If that time passes and you have not heard from the clinic,'
                + ' check the Patient Portal or call.'
                + ' A missing message does not mean the result was normal.',
        },
    ],
    faqCategories: [
...
export function validateClinicConfig(candidate) {
    ...
    if (!['eyebrow', 'heading', 'body'].every((field) => isText(contactSection?.[field]))) {
        issues.push('homeSections.contact must contain complete contact copy')
    }
    ...
    const aboutPage = config.pageContent?.about
    const validMission = ['heading', 'body'].every((field) => isText(aboutPage?.mission?.[field]))
    const validVision = ['heading', 'body'].every((field) => isText(aboutPage?.vision?.[field]))
    const validCoreValues = isText(aboutPage?.coreValues?.heading)
        && Array.isArray(aboutPage?.coreValues?.items)
        && aboutPage.coreValues.items.length > 0
        && aboutPage.coreValues.items.every((value) => (
            isText(value?.id) && isText(value?.name) && isText(value?.description)
        ))
    if (!validMission || !validVision || !validCoreValues) {
        issues.push('pageContent.about must contain complete mission, vision, and core values')
    }
